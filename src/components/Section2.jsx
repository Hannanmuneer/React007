  ...
  return (
    <div className='w-full bg-[#f5f5f5] '>
      <div className="upper pt-5 text-center">
        ...
        <p className='text-[#333] sm:px-4 text-[20px]'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptate, omnis!</p>
      </div>

      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 px-3 sm:gap-6 py-4 sm:py-6">
